...
class CreateUserAdminTransferRecordsTable extends Migration {
	...
	public function up()
	{
		Schema::create('user_admin_transfer_records', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('user_admin_transfer_records');
	}
