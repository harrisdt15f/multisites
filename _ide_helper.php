 ...
 * Generated for Laravel 5.8.33 on 2019-08-27 21:37:09.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         *
         * @return \App\Models\User\FrontendUser|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \App\Models\User\FrontendUser|false 
         * @static 
         */ 
         ...
         *
         * @return \App\Models\User\FrontendUser 
         * @static 
         */ 
    ...
    class Queue {
        ...
        {
                        /** @var \Illuminate\Queue\BeanstalkdQueue $instance */
                        $instance->deleteMessage($queue, $id);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
                        \Illuminate\Queue\BeanstalkdQueue::createPayloadUsing($callback);
        }
...
namespace RicardoFontanelli\LaravelTelegram { 
    ...
    class TelegramFacade {
         ...
         * @static 
         */ 
        public static function setChatList($list)
        {
                        /** @var \RicardoFontanelli\LaravelTelegram\Telegram $instance */
                        return $instance->setChatList($list);
        }
         ...
         * @static 
         */ 
        public static function async($status = true)
        {
                        /** @var \RicardoFontanelli\LaravelTelegram\Telegram $instance */
                        return $instance->async($status);
        }
         ...
         * @static 
         */ 
        public static function getMe($additional_params = array())
        {
                        /** @var \RicardoFontanelli\LaravelTelegram\Telegram $instance */
                        return $instance->getMe($additional_params);
        }
         ...
         * @static 
         */ 
        public static function sendMessage($chatId, $text, $parseMode = 'HTML', $additional_params = array())
        {
                        /** @var \RicardoFontanelli\LaravelTelegram\Telegram $instance */
                        return $instance->sendMessage($chatId, $text, $parseMode, $additional_params);
        }
         ...
         * @static 
         */ 
        public static function getUpdates($offset = 0, $limit = 100, $timeout = 0)
        {
                        /** @var \RicardoFontanelli\LaravelTelegram\Telegram $instance */
                        return $instance->getUpdates($offset, $limit, $timeout);
        }
...
namespace  { 
    ...
    class Telegram extends \RicardoFontanelli\LaravelTelegram\TelegramFacade {}
