<?php namespace App\Lib\Game\Method\Pk10\CQ3;

use App\Lib\Game\Method\Pk10\Base;

class PKQZX3_S extends Base
{
    // 01 02 03,01 02 03,01 02 03,01 02 03,01 02 03,01 02 03,01 02 03,01 02 03,01 02 03
    ...
    {
        //格式
        if (!preg_match("/^(((0[1-9]\s)|(10\s)){2}((0[1-9])|(10))\,)*(((0[1-9]\s)|(10\s)){2}((0[1-9])|(10)))$/", $sCodes)) {
            return false;
        }
        ...
        foreach ($aCode as $sTmpCode) {
            //格式
            if (!preg_match("/^((0[1-9]\s)|(10\s)){2}((0[1-9])|(10))$/", $sTmpCode)) {
                return false;
            }
