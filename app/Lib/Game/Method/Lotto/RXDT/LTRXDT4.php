...
class LTRXDT4 extends Base
{
    ...
    public function count($sCodes)
    {
        ...
        $aDan = explode('&', $aTmp[0]);
        $aTuo = explode('&', $aTmp[1]);
        return $this->getCombinCount(count($aTuo), 4 - count($aDan));
    }
...
for _,str in pairs(ret) do
    ...
    for _,codes2 in pairs(codes) do
        if exists[codes2[1]]==1 and exists[codes2[2]]==1 and exists[codes2[3]]==1 and exists[codes2[4]]==1 then
            do return 0 end
        end
    end
