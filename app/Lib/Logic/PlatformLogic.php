...
class PlatformLogic
{
    ...
    // 添加平台
    public static function addPlatform($platform, $params, $adminId = 0)
    {
        $rules = [
    ...
    // 添加总代
    public static function addTop($sign, $username, $password, $prizeGroup)
    {
        return Player::addTop($sign, $username, $password, $prizeGroup);
    }

    // 添加总代到平台
    public static function addPlatformTopAdminUser($model, $username, $email, $password, $fundPassword, $sign, $adminId = 0)
    {
    ...
    public static function initMenus($sign)
    {
        $menuList = [
            [
                "title" => "__管理员",
     ...
     * @return mixed
     */
    public static function initGroups($sign)
    {
        $groupList = [
            ['运营经理', "运营主管", '运营专员'],
            ['市场经理', "市场主管", '业务专员'],
